@if($currentStep != 1)
    <div style="display: none" class="row setup-content" id="step-1">  {{-- اخفيه لو انا مش واقف فيه --}}
        @endif
        <div class="col-xs-12">
            <div class="col-md-12">
                <br>
                <div class="form-row">
                    <div class="col">
                        ...
                        <input type="email" wire:model="Email"  class="form-control"> {{-- wire:model="Email" => name="Email" --}}
                        @error('Email')
