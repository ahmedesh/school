<div>
    ...
    @if($show_table)  {{-- if(show_table == true) --}}
        @include('livewire.Parent_Table') {{-- الجدول --}}
    @else
                    ...
                    @endif
                            ...
                            <div class="col-md-12"><br>
                                ...
                                <div class="form-group">
                                    ...
                                    {{--  accept="image/*" => عملت فلتره اني اجيب الصور فقط  --}}
                                    {{--  multiple => بستخدم اكتر من ملف اقدر اني ارفعه  --}}
...
{{-- back=>دي فانكشن عملتها فال AddParent.php عندي  --}}
                            @if($updateMode)
