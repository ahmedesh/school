                                                                                                ...
                                                                                                <div class="col">
                                                                                                    ...
                                                                                                    <select multiple name="teacher_id[]" class="form-control" id="exampleFormControlSelect2">
                                                                                                        @foreach($list_Sections->teachers as $teacher)
                                                                                                            <option selected value="{{$teacher['id']}}">{{$teacher['Name']}}</option>{{-- دا عشان يرجعلي اللي موجود معايا بالفعل --}}
                                                                                                        @endforeach

                                                                                                        @foreach($teachers as $teacher)
                                                                                                            <option value="{{$teacher->id}}">{{$teacher->Name}}</option> {{-- دا عشان يرجعلي كلو اختار منه لو عاوز اعدل --}}
                                                                                                        @endforeach
                                                                                                    </select>
                                                                                                </div>
                                                                                            </div>
