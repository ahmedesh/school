...
{{--                                                    <td>{{$attachment->filename}}</td>--}}
                                                    <td>
                                                        @if(isset($attachment->filename))
                                                            <a href="{{URL::asset($attachment->filename)}}" target="_blank">
                                                                <img src="{{URL::asset($attachment->filename)}}" alt="{{$attachment->filename}}"
...
{{--                                                           role="button"><i class="fas fa-download"></i>&nbsp; {{trans('Students_trans.Download')}}</a>--}}
                                                        <a class="btn btn-outline-info btn-sm" href="{{URL::asset($attachment->filename)}}" role="button" download>
                                                            <i class="fas fa-download"></i>&nbsp; {{trans('Students_trans.Download')}} </a>
                                  ...
                                  @include('pages.Students.Delete_img')  {{-- لاحظ حطيته المودولا هنا جوا ال foreach عشان ياخد ال id بتاع كل واحد --}}
                                                {{-- اكني حطيت مودولا هنا بس عشان مكبرش حجم الصفحه هنا بس دا الغرض يعني غرض تافه ههههه --}}
                                            @endforeach
                                            </tbody>
                                        </table>
                                    </div>
