...
class ProcessingFeeRepository implements ProcessingFeeRepositoryInterface
{
    ...
    public function store($request)
    {
        ...
        try {
                    ...
                    if ($request->final_balance >= $request->Debit )
                    {
                    ...
                    return redirect()->back()->withErrors(['error' => '(رصيد الطالب يجب ان يكون اكبر من المبلغ المراد استبعاده)']);
                }
